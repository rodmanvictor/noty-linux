...
The product is local-first, edge-resident desktop notes: individual notes appear as compact coloured tabs and expand only when selected. The project is an independent Linux implementation inspired by the original macOS Noty, not a code fork of it.
...
- The UI is localised; English is the selected language for the public screenshots in this release.
...
- The site uses English copy.
- The project openly credits the original Noty as inspiration and links to it, without presenting itself as an official fork or affiliation.
...
- A real interaction recording supplied for the page: `/home/victor/Videos/Screencasts/noty.mp4`. Published MP4, GIF, and stills are cropped to the English card from that recording; they do not expose neighbouring personal note titles.
